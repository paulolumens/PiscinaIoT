...
try:
	...
	celsius = 25.00
	print('Sensor de temperatura nao responde')
	print('Temperatura recebe 25.00 graus por padrao')
old_celsius = 0
old_valorpsi1 = 0
old_horarios_txt = 0
horarios_txt = 0
	...
	def run(self):
		...
		while self.executando:
			...
			try:
				...
				print('Ph recebe 7.0 por padrao')
			...
			if(motor1_int == 0):
				if (celsius > temperatura_int):
					...
					try:	
						...
						valorpsi1 = 20.0
						print('Sensor Motor1 nao responde')
						print('Psi1 recebe 20.0 por padrao')
